...
# with tempfile.NamedTemporaryFile(dir=working_dir, delete=False) as temp_file:
if True:
        ...
        if band_dim:
            ...
            for band_index_list in band_iterator:
                ...
                cog_translate(
                    ...
                    # f"{working_dir}/my-output-cog-{append_name}.tif",      # Output file path
                    f"my-output-cog-{append_name}.tif",
                    dst_profile,
                ...
                # Fs.write_file(f'{working_dir}/my-output-cog-{append_name}.tif', f'my-output-cog-{append_name}.tif')
